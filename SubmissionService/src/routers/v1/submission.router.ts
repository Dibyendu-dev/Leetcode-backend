...
import { createSubmissionSchema, submissionQuerySchema, updateSubmissionSchema } from "../../validators/submission.validator";
...
submissionRouter.get(
    "/:id",
    submissionController.findSubmissionById
)

submissionRouter.get(
    "/problem/:problemId",
    validateQueryParams(submissionQuerySchema),
    submissionController.findSubmissionNyProblemId
)
